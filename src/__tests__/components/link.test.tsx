...
it("renders link correctly", () => {
  const { asFragment } = renderWithTheme(<Link href="https://kreamswap.finance">Link</Link>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <a
        class="sc-bdfBwQ sc-gsTCUz eiaRqE djpNeP"
        color="primary"
        href="https://kreamswap.finance"
      >
        Link
      </a>
    </DocumentFragment>
...
it("renders link external link correctly", () => {
  const { asFragment } = renderWithTheme(<LinkExternal href="https://kreamswap.finance">Link</LinkExternal>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <a
        class="sc-bdfBwQ sc-gsTCUz eiaRqE djpNeP"
